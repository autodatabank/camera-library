...
//            previewSizePrefKey = context.getString(R.string.adb_cameralibrary_pref_key_rear_camera_preview_size);
//            pictureSizePrefKey = context.getString(R.string.adb_cameralibrary_pref_key_rear_camera_picture_size);
//        } else {
//            previewSizePrefKey = context.getString(R.string.adb_cameralibrary_pref_key_front_camera_preview_size);
//            pictureSizePrefKey = context.getString(R.string.adb_cameralibrary_pref_key_front_camera_picture_size);
//        }
//
//        try {
...
//    }
    ...
    public static boolean shouldHideDetectionInfo(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(R.string.adb_cameralibrary_pref_key_info_hide);
...
//    }
    ...
    public static boolean shouldGroupRecognizedTextInBlocks(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(R.string.adb_cameralibrary_pref_key_group_recognized_text_in_blocks);
        return sharedPreferences.getBoolean(prefKey, false);
    }

    public static boolean showLanguageTag(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(R.string.adb_cameralibrary_pref_key_show_language_tag);
        return sharedPreferences.getBoolean(prefKey, false);
    }

    public static boolean shouldShowTextConfidence(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(R.string.adb_cameralibrary_pref_key_show_text_confidence);
        return sharedPreferences.getBoolean(prefKey, false);
    }
//
//    public static boolean preferGPUForPoseDetection(Context context) {
//        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
//        String prefKey = context.getString(R.string.adb_cameralibrary_pref_key_pose_detector_prefer_gpu);
...
//    }
    ...
    public static boolean isCameraLiveViewportEnabled(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String prefKey = context.getString(R.string.adb_cameralibrary_pref_key_camera_live_viewport);
        return sharedPreferences.getBoolean(prefKey, false);
    }
